import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, defineComponent, computed, provide, Suspense, nextTick, mergeProps, Transition, useSSRContext, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/icons-page-CEVZHqUg.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-lyhsUrZg.js").then(function(n) {
      return n.i;
    }).then((m) => m.default || m)
  }
];
...
const LazySvgIcon = defineAsyncComponent(() => import("./_nuxt/svg-icon-CIyZi82G.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import("./_nuxt/default-CbZRCQVc.js").then((m) => m.default || m),
  "svg-sprite": () => import("./_nuxt/svg-sprite-tmM5sqP1.js").then((m) => m.default || m)
};
